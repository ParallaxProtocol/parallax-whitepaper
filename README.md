...
*The first edition of this paper was published before mainnet launch and is preserved, unmodified, at [editions/first-edition.md](editions/first-edition.md). Editions are immutable once published; corrections and revisions appear only as new editions. A summary of what changed is in [CHANGES.md](CHANGES.md).*
...
[5] The Parallax Doctrine: Axioms and Commentary for Durable Settlement, December 2025. https://github.com/ParallaxProtocol/parallax-doctrine
